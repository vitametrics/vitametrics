    ...
    <div className="font-leagueSpartan bg-fixed ">
      ...
      <div className="py-10 px-32">
        <div className="bg-glass p-10 rounded-xl mt-20">
          ...
          <br />
          <h3 className="text-3xl">Interpretation</h3>
          <p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to vitametrics LLC, 980 Fremont Street
                Monterey, CA 93940.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to vitametrics.org, accessible
                from{" "}
                <a
                  href="https://vitametrics.org/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://vitametrics.org/
                </a>
              </p>
            </li>
            <li>
          ...
          <br />
          <h2 className="text-4xl">Acknowledgment</h2>
          <p>
          ...
          <ul>
            <li>By email: vitametrics@mpc.edu</li>
          </ul>
        </div>
      </div>
