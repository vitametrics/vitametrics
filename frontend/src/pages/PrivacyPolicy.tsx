  ...
  return (
    <div className="flex bg-fixed ">
      ...
      <div className=" p-5 dark:text-white">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to vitametrics Team LLC, 980 Fremont St,
              Monterey, CA 93940.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to vitametrics, accessible from{" "}
              <a
        ...
        <ul>
          <li>
            <p>By email: contact@vitametrics.org</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://vitametrics.org/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://vitametrics.org/contact
              </a>
            </p>
          </li>
        </ul>
